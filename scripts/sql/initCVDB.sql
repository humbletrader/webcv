...
create table user (id integer not null, first_name varchar(255), last_name varchar(255), photo_link varchar(255), username varchar(255), primary key (id));
...
alter table certification_users add constraint FKh9y8gwcl7k45sje598fqi39wo foreign key (users_id) references user;
...
alter table experience add constraint FK41lup37auw1bvwwqpgn0blbic foreign key (user_id) references user;
...
alter table user_certifications add constraint FKa0hui5lh4nflm8oojgvcg4ewc foreign key (user_id) references user;
